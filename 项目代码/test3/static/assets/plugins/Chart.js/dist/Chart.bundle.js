...
module.exports = function(Chart) {
	...
	Chart.controllers.bar = Chart.DatasetController.extend({
		...
		dataElementType: Chart.houseinfo.Rectangle,
		...
		updateElement: function updateElement(rectangle, index, reset) {
			...
			var rectangleElementOptions = this.chart.options.houseinfo.rectangle;
...
module.exports = function(Chart) {
	...
	Chart.controllers.bubble = Chart.DatasetController.extend({
		...
		dataElementType: Chart.houseinfo.Point,
		...
		updateElement: function(point, index, reset) {
			...
			var pointElementOptions = this.chart.options.houseinfo.point;
		...
		getRadius: function(value) {
			return value.r || this.chart.options.houseinfo.point.radius;
		},
		...
		setHoverStyle: function(point) {
			...
			model.radius = custom.hoverRadius ? custom.hoverRadius : (helpers.getValueAtIndexOrDefault(dataset.hoverRadius, index, this.chart.options.houseinfo.point.hoverRadius)) + this.getRadius(this.getDataset().data[point._index]);
			model.backgroundColor = custom.hoverBackgroundColor ? custom.hoverBackgroundColor : helpers.getValueAtIndexOrDefault(dataset.hoverBackgroundColor, index, helpers.getHoverColor(model.backgroundColor));
			model.borderColor = custom.hoverBorderColor ? custom.hoverBorderColor : helpers.getValueAtIndexOrDefault(dataset.hoverBorderColor, index, helpers.getHoverColor(model.borderColor));
			model.borderWidth = custom.hoverBorderWidth ? custom.hoverBorderWidth : helpers.getValueAtIndexOrDefault(dataset.hoverBorderWidth, index, model.borderWidth);
		},
...
module.exports = function(Chart) {
				...
				generateLabels: function(chart) {
					...
					if (data.labels.length && data.datasets.length) {
						return data.labels.map(function(label, i) {
							...
							var arcOpts = chart.options.houseinfo.arc;
	...
	Chart.controllers.doughnut = Chart.controllers.pie = Chart.DatasetController.extend({
		...
		dataElementType: Chart.houseinfo.Arc,
		...
		removeHoverStyle: function(arc) {
			Chart.DatasetController.prototype.removeHoverStyle.call(this, arc, this.chart.options.houseinfo.arc);
		},
...
module.exports = function(Chart) {
	...
	Chart.controllers.line = Chart.DatasetController.extend({
		...
		datasetElementType: Chart.houseinfo.Line,
		...
		getPointBackgroundColor: function(point, index) {
			var backgroundColor = this.chart.options.houseinfo.point.backgroundColor;
			var dataset = this.getDataset();
			var custom = point.custom || {};
		...
		getPointBorderColor: function(point, index) {
			var borderColor = this.chart.options.houseinfo.point.borderColor;
			var dataset = this.getDataset();
			var custom = point.custom || {};
		...
		getPointBorderWidth: function(point, index) {
			var borderWidth = this.chart.options.houseinfo.point.borderWidth;
			var dataset = this.getDataset();
			var custom = point.custom || {};
		...
		updateElement: function(point, index, reset) {
			...
			var pointOptions = me.chart.options.houseinfo.point;
			var x, y;
		...
		setHoverStyle: function(point) {
			...
			model.radius = custom.hoverRadius || helpers.getValueAtIndexOrDefault(dataset.pointHoverRadius, index, this.chart.options.houseinfo.point.hoverRadius);
		...
		removeHoverStyle: function(point) {
			...
			model.radius = custom.radius || helpers.getValueAtIndexOrDefault(dataset.pointRadius, index, me.chart.options.houseinfo.point.radius);
...
module.exports = function(Chart) {
	...
	Chart.controllers.radar = Chart.DatasetController.extend({
		...
		update: function update(reset) {
			...
			var dataset = this.getDataset();
			var lineElementOptions = this.chart.options.houseinfo.line;
		...
		updateElement: function(point, index, reset) {
			...
			helpers.extend(point, {
				...
				_model: {
					...
					// Appearance
					tension: custom.tension ? custom.tension : helpers.getValueOrDefault(dataset.tension, this.chart.options.houseinfo.line.tension),
		...
		setHoverStyle: function(point) {
			...
			model.radius = custom.hoverRadius ? custom.hoverRadius : helpers.getValueAtIndexOrDefault(dataset.pointHoverRadius, index, this.chart.options.houseinfo.point.hoverRadius);
...
module.exports = function(Chart) {
	...
	Chart.Legend = Chart.Element.extend({
		...
		draw: function() {
			...
			var labelOpts = opts.labels;
			var globalDefault = Chart.defaults.global,
				lineDefault = globalDefault.houseinfo.line,
...
module.exports = function(Chart, moment) {
  ...
  globalOpts.houseinfo.arc = {
    backgroundColor: globalOpts.defaultColor,
    borderColor: "#fff",
    borderWidth: 2
  };

  Chart.houseinfo.Arc = Chart.Element.extend({
...
module.exports = function(Chart) {
	...
	Chart.defaults.global.houseinfo.line = {
		tension: 0.4,
	...
	Chart.houseinfo.Line = Chart.Element.extend({
		...
		draw: function() {
			...
			var globalOptionLineElements = globalDefaults.houseinfo.line;
...
module.exports = function(Chart) {
	...
	Chart.houseinfo.Point = Chart.Element.extend({
		inRange: function(mouseX, mouseY) {
			var vm = this._view;
		...
		draw: function() {
			...
			ctx.lineWidth = helpers.getValueOrDefault(vm.borderWidth, globalOpts.houseinfo.point.borderWidth);
...
module.exports = function(Chart) {
	...
	globalOpts.houseinfo.rectangle = {
		backgroundColor: globalOpts.defaultColor,
		borderWidth: 0,
	...
	Chart.houseinfo.Rectangle = Chart.Element.extend({
		draw: function() {
			var ctx = this._chart.ctx;
			var vm = this._view;
