                ...
                t.controllers.bar = t.DatasetController.extend({
                    dataElementType: a.Rectangle, initialize: function () {
                        ...
                        var i = this, a = i.chart, r = i.getMeta(), l = i.getDataset(), s = t.custom || {},
                            u = a.options.houseinfo.rectangle;
                        ...
                        var e = this.chart.data.datasets[t._datasetIndex], n = t._index, i = t.custom || {},
                            a = t._model, r = this.chart.options.houseinfo.rectangle;
                ...
                t.controllers.bubble = t.DatasetController.extend({
                    dataElementType: a.Point, update: function (t) {
                        ...
                        var n, i, a, r = this, l = r.chart, s = l.data.datasets[r.index], u = t.custom || {},
                            d = l.options.houseinfo.point, c = o.options.resolve, h = s.data[e], f = {},
            ...
            i._set("doughnut", {
                        ...
                        generateLabels: function (t) {
                            ...
                            return e.labels.length && e.datasets.length ? e.labels.map(function (n, i) {
                                var a = t.getDatasetMeta(0), r = e.datasets[0], l = a.data[i], s = l && l.custom || {},
                                    u = o.valueAtIndexOrDefault, d = t.options.houseinfo.arc;
                                return {
                                    text: n,
                ...
                t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                    dataElementType: a.Arc, linkScales: o.noop, getRingIndex: function (t) {
                        ...
                        var e = this, n = e.chart, i = n.chartArea, a = n.options, r = a.houseinfo.arc,
                        ...
                        t.DatasetController.prototype.removeHoverStyle.call(this, e, this.chart.options.houseinfo.arc)
                ...
                t.controllers.line = t.DatasetController.extend({
                    datasetElementType: a.Line, dataElementType: a.Point, update: function (t) {
                        var n, i, a, r = this, l = r.getMeta(), s = l.dataset, u = l.data || [], d = r.chart.options,
                            c = d.houseinfo.line, h = r.getScaleForId(l.yAxisID), f = r.getDataset(), g = e(f, d);
                        ...
                        var n = this.chart.options.houseinfo.point.backgroundColor, i = this.getDataset(),
                            a = t.custom || {};
                        ...
                        var n = this.chart.options.houseinfo.point.borderColor, i = this.getDataset(),
                            a = t.custom || {};
                        ...
                        var n = this.chart.options.houseinfo.point.borderWidth, i = this.getDataset(),
                            a = t.custom || {};
                        ...
                        var i, a, r = this, l = r.getMeta(), s = t.custom || {}, u = r.getDataset(), d = r.index,
                            ...
                            g = r.chart.options.houseinfo.point;
                        ...
                        if (r.chart.options.houseinfo.line.capBezierPoints) for (e = 0, n = u.length; e < n; ++e) (i = u[e]._model).controlPointPreviousX = t(i.controlPointPreviousX, s.left, s.right), i.controlPointPreviousY = t(i.controlPointPreviousY, s.top, s.bottom), i.controlPointNextX = t(i.controlPointNextX, s.left, s.right), i.controlPointNextY = t(i.controlPointNextY, s.top, s.bottom)
                    }, draw: function () {
                        ...
                        var e = this.chart.data.datasets[t._datasetIndex], n = t._index, i = t.custom || {},
                            a = t._model;
                        a.radius = i.hoverRadius || o.valueAtIndexOrDefault(e.pointHoverRadius, n, this.chart.options.houseinfo.point.hoverRadius), a.backgroundColor = i.hoverBackgroundColor || o.valueAtIndexOrDefault(e.pointHoverBackgroundColor, n, o.getHoverColor(a.backgroundColor)), a.borderColor = i.hoverBorderColor || o.valueAtIndexOrDefault(e.pointHoverBorderColor, n, o.getHoverColor(a.borderColor)), a.borderWidth = i.hoverBorderWidth || o.valueAtIndexOrDefault(e.pointHoverBorderWidth, n, a.borderWidth)
                    }, removeHoverStyle: function (t) {
                        var e = this, n = e.chart.data.datasets[t._datasetIndex], i = t._index, a = t.custom || {},
                            r = t._model;
                        void 0 !== n.radius && void 0 === n.pointRadius && (n.pointRadius = n.radius), r.radius = a.radius || o.valueAtIndexOrDefault(n.pointRadius, i, e.chart.options.houseinfo.point.radius), r.backgroundColor = e.getPointBackgroundColor(t, i), r.borderColor = e.getPointBorderColor(t, i), r.borderWidth = e.getPointBorderWidth(t, i)
                    }
                })
            }
            ...
            i._set("polarArea", {
                        ...
                        generateLabels: function (t) {
                            ...
                            return e.labels.length && e.datasets.length ? e.labels.map(function (n, i) {
                                var a = t.getDatasetMeta(0), r = e.datasets[0], l = a.data[i].custom || {},
                                    s = o.valueAtIndexOrDefault, u = t.options.houseinfo.arc;
                                return {
                                    text: n,
                ...
                t.controllers.polarArea = t.DatasetController.extend({
                    dataElementType: a.Arc, linkScales: o.noop, update: function (t) {
                        var e = this, n = e.chart, i = n.chartArea, a = e.getMeta(), r = n.options, l = r.houseinfo.arc,
                ...
                t.controllers.radar = t.DatasetController.extend({
                    datasetElementType: a.Line, dataElementType: a.Point, linkScales: o.noop, update: function (t) {
                        var e = this, n = e.getMeta(), i = n.dataset, a = n.data, r = i.custom || {},
                            l = e.getDataset(), s = e.chart.options.houseinfo.line, u = e.chart.scale;
                        ...
                        var i = this, a = t.custom || {}, r = i.getDataset(), l = i.chart.scale,
                            s = i.chart.options.houseinfo.point, u = l.getPointPositionForValue(e, r.data[e]);
                        void 0 !== r.radius && void 0 === r.pointRadius && (r.pointRadius = r.radius), void 0 !== r.hitRadius && void 0 === r.pointHitRadius && (r.pointHitRadius = r.hitRadius), o.extend(t, {
                            ...
                            _model: {
                                x: n ? l.xCenter : u.x,
                                y: n ? l.yCenter : u.y,
                                tension: a.tension ? a.tension : o.valueOrDefault(r.lineTension, i.chart.options.houseinfo.line.tension),
                        ...
                        var e = this.chart.data.datasets[t._datasetIndex], n = t.custom || {}, i = t._index,
                            a = t._model;
                        a.radius = n.hoverRadius ? n.hoverRadius : o.valueAtIndexOrDefault(e.pointHoverRadius, i, this.chart.options.houseinfo.point.hoverRadius), a.backgroundColor = n.hoverBackgroundColor ? n.hoverBackgroundColor : o.valueAtIndexOrDefault(e.pointHoverBackgroundColor, i, o.getHoverColor(a.backgroundColor)), a.borderColor = n.hoverBorderColor ? n.hoverBorderColor : o.valueAtIndexOrDefault(e.pointHoverBorderColor, i, o.getHoverColor(a.borderColor)), a.borderWidth = n.hoverBorderWidth ? n.hoverBorderWidth : o.valueAtIndexOrDefault(e.pointHoverBorderWidth, i, a.borderWidth)
                    }, removeHoverStyle: function (t) {
                        var e = this.chart.data.datasets[t._datasetIndex], n = t.custom || {}, i = t._index,
                            a = t._model, r = this.chart.options.houseinfo.point;
            ...
            i._set("global", {
                ...
                return t.Legend = a.extend({
                    initialize: function (t) {
                        ...
                        var t = this, n = t.options, a = n.labels, r = i.global, l = r.houseinfo.line, s = t.width,
                            u = t.lineWidths;
                        if (n.display) {
